...
export const OurStory = () => {
  return (
    <section className="flex flex-col lg:flex-row justify-between gap-6 md:gap-0 py-16 lg:py-0 lg:pt-16 px-4 md:px-12 xl:px-24 w-full">
      <div className="w-full lg:w-1/2 flex flex-col xs:items-center lg:items-start">
        <div className="">
          <Image
