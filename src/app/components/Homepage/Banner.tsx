...
export const Banner = () => {
  return (
    <section className="pb-16 px-4 md:px-12 xl:px-24 w-full bg-secondary-green">
      <div className="flex flex-col gap-6 sm:gap-10 items-center justify-center py-10 px-2 sm:px-4 bg-primary-green rounded-[20px]">
        ...
        <div className="flex justify-center md:justify-start space-x-2 md:space-x-4 text-primary-green">
          <button className="flex bg-white rounded-lg gap-1 xxs:gap-2 items-center px-1 xxs:px-3 md:px-5 py-3">
            <Image
